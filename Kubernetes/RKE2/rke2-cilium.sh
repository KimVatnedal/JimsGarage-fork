...
lbrange=192.168.20.160-192.168.20.189
...
curl -sL https://raw.githubusercontent.com/KimVatnedal/JimsGarage-fork/rke2-cilium/Kubernetes/RKE2/k3s |  vipAddress=$vip vipInterface=$interface vipVersion=$KVVERSION sh | sudo tee /var/lib/rancher/rke2/server/manifests/kube-vip.yaml
...
exit
EOF
echo -e " \033[32;5mMaster1 first setup Completed\033[0m"
