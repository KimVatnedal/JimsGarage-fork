...
curl -sL https://raw.githubusercontent.com/JamesTurland/JimsGarage/main/Kubernetes/RKE2/k3s |  vipAddress=$vip vipInterface=$interface vipVersion=$KVVERSION sh | sudo tee /var/lib/rancher/rke2/server/manifests/kube-vip.yaml
